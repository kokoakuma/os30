...
void HariMain(void)
{
	...
	putfonts8_asc(binfo->vram, binfo->scrnx, 30, 53, COL8_000000, "Hello world. let s start programming");
	putfonts8_asc(binfo->vram, binfo->scrnx, 30, 52, COL8_FFFFFF, "Hello world. let s start programming");
